...
class AdminMedicationHistoryScreen extends StatefulWidget {
  final void Function(bool isVisible)? onFabVisibilityChanged;

  const AdminMedicationHistoryScreen({super.key, this.onFabVisibilityChanged});

  @override
  State<AdminMedicationHistoryScreen> createState() =>
      AdminMedicationHistoryScreenState();
}

class AdminMedicationHistoryScreenState
    extends State<AdminMedicationHistoryScreen> {
